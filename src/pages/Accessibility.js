...
export default function Accessibility() {
  return <section>
    <div class="nav-info-about">
        ...
        <img class="nav-p-abt" src={img3} alt=""/>
    </div>
    <div class="services">
        <div class="tech2u-impact">
            <div class="access-row">
                <ul>
                    ...
                    <li>Video cameras with operators in the room increased access to course materials for students online or at the back of the classroom</li>
