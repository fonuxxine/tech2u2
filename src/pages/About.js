    ...
    <div class="nav-info">
        <div class="nav-text box-about3">
            ...
            <p>The Tech2U program humanizes classroom technical support to foster excellent and innovative teaching and learning in an
                increasingly technological classroom. The program provides real-time, personalized technical support for instructors by a trained team of students and experienced technicians.</p>
        </div>
